    ...
    <header class="navbar-gradient text-white shadow-md">
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <nav class="flex gap-6 items-center">
                ...
                <a href="{{ route('cliente.pedidos.index') }}" class="hover:underline font-semibold transition">Mis Pedidos</a>
                <a href="{{ route('cliente.pagos.index') }}" class="hover:underline font-semibold transition">Mis Pagos</a>
                <a href="{{ route('cliente.calificaciones.index') }}" class="hover:underline font-semibold transition">Mis Calificaciones</a>
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-72 bg-white rounded-md shadow-lg py-1 z-10 hidden group-hover:block">
                        ...
                        @if(Auth::user()->notificaciones()->count() > 0)
                            ...
                            @endforeach
                            <a href="{{ route('cliente.notificaciones.index') }}" class="block px-4 py-2 text-center text-orange-600 hover:underline">Ver todas</a>
                        @else
                ...
                @auth
                    <div class="relative group ml-4">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-10 hidden group-hover:block">
                            <a href="{{ route('cliente.perfil') }}" class="block px-4 py-2 text-gray-800 hover:bg-orange-100">Mi Perfil</a>

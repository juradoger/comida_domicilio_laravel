                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    ...
                                    @elseif($pago->pedido->estado == 'cancelado') bg-red-100 text-red-800
                                    @endif">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-gray-800 font-bold">S/ {{ number_format($pago->pedido->total, 2) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 border-t pt-4">
                    <div class="flex justify-end">
                        <form action="{{ route('cliente.pagos.cancelar', $pago->id) }}" method="POST" class="inline">
                            @csrf
                            @method('PUT')
                            <button type="submit" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded transition duration-300" onclick="return confirm('¿Estás seguro de cancelar este pago?')">
                                Cancelar Pago
                            </button>
                        </form>
                    </div>

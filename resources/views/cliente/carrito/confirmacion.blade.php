        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
            <div class="p-8 text-center">
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-bold text-orange-600">S/. {{ number_format($pedido->total, 2) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6 text-left">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <span class="font-medium">{{ $pedido->created_at->addMinutes(45)->format('H:i') }} - {{ $pedido->created_at->addMinutes(60)->format('H:i') }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-4">
                        @foreach($pedido->detalles as $detalle)
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium">S/. {{ number_format($detalle->precio_unitario * $detalle->cantidad, 2) }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="mt-8 space-y-4">
                    <p class="text-gray-600">Recibirás actualizaciones sobre el estado de tu pedido por correo electrónico y en la sección "Mis Pedidos".</p>
                    
                    <div class="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
                        <a href="{{ route('cliente.pedidos.show', $pedido->id) }}" class="bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white font-bold py-2 px-6 rounded-md transition duration-300 inline-block">
                            Ver Detalles del Pedido
                        </a>
                        <a href="{{ route('cliente.menu') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-6 rounded-md transition duration-300 inline-block">
                            Volver al Menú
                        </a>
                    </div>
                </div>

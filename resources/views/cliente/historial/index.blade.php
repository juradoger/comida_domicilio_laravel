    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-2">
                <div class="relative">
                    <input type="text" id="buscar" placeholder="Buscar por restaurante o producto" class="w-64 rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-200 pl-10">
                    <div class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                        <i class="fas fa-search"></i>
                    </div>
                </div>
                <select id="filtroFecha" class="rounded-md border-gray-300 shadow-sm focus:border-orange-500 focus:ring focus:ring-orange-200">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">S/ {{ number_format($estadisticas['total_gastado'], 2) }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ $estadisticas['restaurante_favorito'] ?: 'Sin datos' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ $estadisticas['producto_favorito'] ?: 'Sin datos' }}</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach($pedidos as $pedido)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">
                                            ...
                                            @if($pedido->detalles->count() > 2)
                                                <div class="text-gray-500 text-xs">+{{ $pedido->detalles->count() - 2 }} más</div>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('cliente.pedidos.show', $pedido->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Ver</a>
                                        @if($pedido->estado == 'entregado')
                                            <a href="{{ route('cliente.pedidos.repetir', $pedido->id) }}" class="text-green-600 hover:text-green-900">Repetir</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function filtrarTabla() {
                ...
                filas.forEach(fila => {
                    ...
                    const coincideTexto = restaurante.includes(textoBusqueda) || productos.includes(textoBusqueda);

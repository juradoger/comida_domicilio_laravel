                        ...
                        <div class="space-y-4">
                            @foreach ($pedido->detalles as $detalle)
                                <div class="flex items-center">
                                    <img src="{{ asset($detalle->producto->imagen) }}"
                                    ...
                                    <div class="text-right">
                                        <p class="font-medium text-gray-800">Bs.
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6">
                    ...
                    <form action="{{ route('cliente.pedidos.guardar-calificacion', $pedido->id) }}" method="POST">
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex items-center">
                                <div class="rating-stars flex space-x-1" id="rating-general">
                                    <input type="hidden" name="calificacion_general" id="calificacion-general-input"
                                        value="5">
                                    @for ($i = 1; $i <= 5; $i++)
                                        <button type="button" class="star-btn text-2xl" data-rating="{{ $i }}"
                                            data-target="general">
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="rating-stars flex space-x-1" id="rating-comida">
                                        <input type="hidden" name="calificacion_comida" id="calificacion-comida-input"
                                            value="5">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <button type="button" class="star-btn text-xl"
                                                data-rating="{{ $i }}" data-target="comida">
                                                <i class="fas fa-star text-yellow-400"></i>
                                            </button>
                                        @endfor
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="rating-stars flex space-x-1" id="rating-tiempo">
                                        <input type="hidden" name="calificacion_tiempo" id="calificacion-tiempo-input"
                                            value="5">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <button type="button" class="star-btn text-xl"
                                                data-rating="{{ $i }}" data-target="tiempo">
                                                <i class="fas fa-star text-yellow-400"></i>
                                            </button>
                                        @endfor
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="rating-stars flex space-x-1" id="rating-repartidor">
                                        <input type="hidden" name="calificacion_repartidor"
                                            id="calificacion-repartidor-input" value="5">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <button type="button" class="star-btn text-xl"
                                                data-rating="{{ $i }}" data-target="repartidor">
                                                <i class="fas fa-star text-yellow-400"></i>
                                            </button>
                                        @endfor
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <div class="rating-stars flex space-x-1" id="rating-precio">
                                        <input type="hidden" name="calificacion_precio" id="calificacion-precio-input"
                                            value="5">
                                        @for ($i = 1; $i <= 5; $i++)
                                            <button type="button" class="star-btn text-xl"
                                                data-rating="{{ $i }}" data-target="precio">
                                                <i class="fas fa-star text-yellow-400"></i>
                                            </button>
                                        @endfor
                                    </div>
                        ...
                        <!-- Comentario -->
                        <div class="mb-8">
                            <label for="comentario" class="block text-lg font-semibold text-gray-800 mb-3">Tu
                                Comentario</label>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                @foreach ($pedido->detalles as $detalle)
                                    <div class="flex items-center">
                                        <input type="checkbox" id="producto-{{ $detalle->id }}"
                                            name="productos_destacados[]" value="{{ $detalle->producto_id }}"
                                            class="rounded border-gray-300 text-orange-500 focus:border-orange-500 focus:ring focus:ring-orange-200">
                                        <label for="producto-{{ $detalle->id }}"
                                            class="ml-2 text-gray-700">{{ $detalle->producto->nombre }}</label>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div class="flex justify-end space-x-4">
                            <a href="{{ route('cliente.pedidos.show', $pedido->id) }}"
                                class="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition duration-200">Cancelar</a>
                            <button type="submit"
                                class="px-6 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 transition duration-200">Enviar
                                Calificación</button>
                        </div>
                    </form>
                </div>

...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
            <div class="p-6">
                <p class="text-gray-600 mb-8">Encuentra respuestas a las preguntas más comunes sobre nuestros servicios,
                    pedidos, pagos y más.</p>

                <!-- Categorías de FAQ -->
                <div class="flex flex-wrap gap-2 mb-8">
                    <button class="category-btn active bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-medium"
                        data-category="all">Todas</button>
                    <button
                        class="category-btn bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-full text-sm font-medium"
                        data-category="pedidos">Pedidos</button>
                    <button
                        class="category-btn bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-full text-sm font-medium"
                        data-category="pagos">Pagos</button>
                    <button
                        class="category-btn bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-full text-sm font-medium"
                        data-category="entregas">Entregas</button>
                    <button
                        class="category-btn bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-full text-sm font-medium"
                        data-category="cuenta">Mi Cuenta</button>
                </div>
                ...
                <div class="space-y-4" id="faq-container">
                    ...
                    <div class="faq-item" data-category="pedidos">
                        <button
                            class="faq-question w-full flex justify-between items-center text-left p-4 rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                    ...
                    <div class="faq-item" data-category="pedidos">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            <p class="text-gray-600">
                                Puedes cancelar tu pedido siempre y cuando esté en estado "Pendiente". Una vez que el pedido
                                cambia a "En proceso", ya no es posible cancelarlo directamente desde la plataforma.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Para cancelar un pedido pendiente, ve a la sección "Mis Pedidos", busca el pedido que deseas
                                cancelar y haz clic en el botón "Cancelar".
                            </p>
                            <p class="text-gray-600 mt-2">
                                Si necesitas modificar un pedido que ya está en proceso, te recomendamos contactar
                                directamente con nuestro servicio de atención al cliente lo antes posible.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-category="pedidos">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            ...
                            <ol class="list-decimal list-inside mt-2 space-y-2 text-gray-600">
                                ...
                                <li>Haz clic en "Ver detalles" para obtener información detallada sobre el estado actual
                                </li>
                            </ol>
                            <p class="text-gray-600 mt-2">
                                También recibirás notificaciones por correo electrónico y en la plataforma cuando el estado
                                de tu pedido cambie.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-category="pagos">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            <p class="text-gray-600">
                                Sí, todas nuestras transacciones en línea están protegidas con tecnología de encriptación
                                SSL de 256 bits, lo que garantiza que tu información de pago esté segura. No almacenamos los
                                datos completos de tu tarjeta en nuestros servidores.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Además, trabajamos con pasarelas de pago reconocidas y confiables que cumplen con los
                    ...
                    <div class="faq-item" data-category="entregas">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            <p class="text-gray-600">
                                El tiempo estimado de entrega es de 30 a 45 minutos, dependiendo de la distancia y las
                                condiciones del tráfico. Durante horas pico o condiciones climáticas adversas, el tiempo de
                                entrega podría extenderse.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Una vez que realices tu pedido, te proporcionaremos un tiempo estimado de entrega más
                                preciso. También puedes seguir el estado de tu pedido en tiempo real a través de nuestra
                                plataforma.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-category="entregas">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            <p class="text-gray-600">
                                El costo de envío se calcula automáticamente en función de la distancia entre nuestro
                                restaurante y tu dirección de entrega. El costo base es de Bs. 5.00 para distancias menores
                                a 3 km.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Para pedidos superiores a Bs. 50.00, el envío es gratuito dentro de un radio de 5 km.
                            </p>
                            <p class="text-gray-600 mt-2">
                                El costo exacto de envío se mostrará durante el proceso de checkout antes de confirmar tu
                                pedido.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="faq-item" data-category="entregas">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            <p class="text-gray-600">
                                Sí, ofrecemos la opción de programar entregas con anticipación. Durante el proceso de
                                checkout, puedes seleccionar la fecha y hora en la que deseas recibir tu pedido.
                            </p>
                            <p class="text-gray-600 mt-2">
                                Las entregas programadas están disponibles con un mínimo de 2 horas de anticipación y hasta
                    ...
                    <div class="faq-item" data-category="cuenta">
                        <button
                            class="faq-question w-full flex justify-between items-center text-left p-4 rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500">
                            <span class="font-medium text-gray-800">¿Cómo puedo gestionar mis direcciones de
                                entrega?</span>
                            <i class="fas fa-chevron-down text-gray-500 transition-transform"></i>
                        </button>
                        <div class="faq-answer hidden p-4 bg-white">
                    ...
                    <div class="faq-item" data-category="cuenta">
                        ...
                        <div class="faq-answer hidden p-4 bg-white">
                            ...
                            <p class="text-gray-600 mt-2">
                                Si olvidaste tu contraseña, puedes usar la opción "¿Olvidaste tu contraseña?" en la página
                                de inicio de sesión para restablecerla.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div id="no-results" class="hidden text-center py-8">
                    ...
                    <p class="text-gray-600 mt-2">Intenta con otros términos o <a href="#"
                            class="text-orange-600 hover:text-orange-800">contáctanos</a> directamente.</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                <p class="text-gray-600 mb-4">Si tienes alguna pregunta que no ha sido respondida, no dudes en
            ...
            searchInput.addEventListener('input', function() {
                ...
                faqItems.forEach(item => {
                    ...
                    if (question.includes(searchTerm) || answer.includes(searchTerm)) {
                        ...
                        if (activeCategory === 'all' || item.getAttribute('data-category') ===
                            activeCategory) {
                            item.classList.remove('hidden');
                            visibleCount++;
                        } else {
